...
// ZhumuSdkProgress.cpp : 定义应用程序的类行为。
//
...
BEGIN_MESSAGE_MAP(CZhumuSdkProgressApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CZhumuSdkProgressApp 构造

CZhumuSdkProgressApp::CZhumuSdkProgressApp()
{
	// 支持重新启动管理器
...
// 唯一的一个 CZhumuSdkProgressApp 对象

CZhumuSdkProgressApp theApp;


// CZhumuSdkProgressApp 初始化
